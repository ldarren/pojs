...
function Collection(seed){
	...
	this.cache = cache
	this.encodeCacheKey = encodeCacheKey
	this.decodeCacheKey = decodeCacheKey
...
Collection.prototype={
	...
	init:function(name, opt){
		...
		this.cache = opt.cache || cache
		this.encodeCacheKey = opt.encodeCacheKey || encodeCacheKey
		this.decodeCacheKey = opt.decodeCacheKey || decodeCacheKey
	},
	fini:function(){},
