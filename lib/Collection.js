...
Collection.prototype={
	...
	create:function(model,cb){
		var coll=this
		ajax('post',this.routes.create,model,function(err,res){
			if (err) return cb(err)
	...
	read:function(id,cb){
		...
		ajax('get',this.routes.read,params,function(err,res){
			if (err) return cb(err)
			cb(null,set(coll,res))
		})
	},
	...
	list:function(list,cb){
		...
		ajax('get',this.routes.list,params,function(err,res){
			if (err) return cb(err)
	...
	update:function(model,cb){
		var coll=this
		ajax('put',this.routes.update,model,function(err,res){
			if (err) return cb(err)
			cb(null,set(coll,res))
		})
	},
	remove:function(id,cb){
		...
		var params={}
		params[this.idAttr]=id
		ajax('delete',this.routes.delete,params,function(err,res){
			if (err) return cb(err)
